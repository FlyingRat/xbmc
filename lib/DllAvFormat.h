...
#pragma warning(disable:4244)
  ...
  // void av_read_frame_flush(AVFormatContext *s); // @FFMPEG113: av_read_frame_flush decrepated
  void ff_read_frame_flush(AVFormatContext *s);    // @FFMPEG113 internal
#else
  #include "libavformat/avformat.h"
  void ff_read_frame_flush(AVFormatContext *s);    // @FFMPEG113 internal
#endif
...
public:
  ...
  virtual void av_read_frame_flush(AVFormatContext *s) { ::ff_read_frame_flush(s); } // @FFMPEG113: av_read_frame_flush decrepated 
