...
/*
** @FFMPEG113
** "DllPaths_win32_ffmpeg.h" is generated by the win32 configure and build
** script "build_xbmc_win32.sh" located in "$XBMC_SRC_ROOT/xbmc/lib/ffmpeg"
*/
#include "DllPaths_win32_ffmpeg.h"

/*
** @FFMPEG113 - old definitions
** 
...
** 
** @FFMPEG113 - for later use when the ffmpeg linkage issue is fixed for win32 (MinGW32)...
** 
